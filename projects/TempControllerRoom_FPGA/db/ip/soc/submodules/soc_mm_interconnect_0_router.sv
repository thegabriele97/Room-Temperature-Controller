...
(
    ...
    localparam PAD6 = log2ceil(64'h100000a0 - 64'h10000080); 
    localparam PAD7 = log2ceil(64'h100000c0 - 64'h100000a0); 
    localparam PAD8 = log2ceil(64'h100000e0 - 64'h100000c0); 
    localparam PAD9 = log2ceil(64'h10000100 - 64'h100000e0); 
    localparam PAD10 = log2ceil(64'h10000120 - 64'h10000100); 
    localparam PAD11 = log2ceil(64'h10000140 - 64'h10000120); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h10000140;
    ...
    // ( 0x10000080 .. 0x100000a0 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 29'h10000080   ) begin
            src_channel = 12'b000001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x100000a0 .. 0x100000c0 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 29'h100000a0   ) begin
            src_channel = 12'b000010000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0x100000c0 .. 0x100000e0 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 29'h100000c0   ) begin
            src_channel = 12'b000100000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
    end

    // ( 0x100000e0 .. 0x10000100 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 29'h100000e0   ) begin
            src_channel = 12'b001000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
    end

    // ( 0x10000100 .. 0x10000120 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 29'h10000100   ) begin
            src_channel = 12'b010000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x10000120 .. 0x10000140 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 29'h10000120   ) begin
